...
public enum PlayerColor {
    ...
    RED("§4", Arrays.asList(255, 0, 0), null), // Granny -> Angry
    BLUE("§1", Arrays.asList(93, 0, 255), null),
    GREEN("§2", Arrays.asList(16, 170, 0), null), // Percey -> Creepy
    PINK("§d", Arrays.asList(255, 0, 252), null),
    ORANGE("§6", Arrays.asList(242, 154, 0), null),
    YELLOW("§e", Arrays.asList(242, 239, 0), null), // Pahpy -> Happy
    BLACK("§0", Arrays.asList(45, 45, 45), null), // RicSpy -> Crispy
    WHITE("§f", Arrays.asList(241, 241, 241), null),
    PURPLE("§5", Arrays.asList(130, 0, 230), null), // EddyScar -> Scaredy
    BROWN("§c", Arrays.asList(84, 64, 0), null),
    CYAN("§b", Arrays.asList(0, 255, 255), null), // Azyl -> Lazy
